...
(function () {
  ...
  // ---- exposed for the dashboard's inline position/pending action buttons (app.js) ----
  window.ruleAction = (action, coin, params) => adminFetch('/api/rule-action', {
    method: 'POST', headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ action, coin, params: params || {} }),
  });
  window.adminReady = () => !!A.token;
